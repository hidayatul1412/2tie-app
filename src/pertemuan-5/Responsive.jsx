...
function ResponsiveText(){
    return (
        <p className="text-sm md:text-lg md:text-blue-500 lg:text-xl lg:text-amber-200 xl:text-2xl mb-4">
    ...
    return (
        <div className="mb-4">
            ...
            <div className="flex flex-col sm:flex-row mb-4">
                <div className="bg-red-400 w-full sm:w-1/2 p-4">Kolom 1</div>
                <div className="bg-blue-400 w-full sm:w-1/2 p-4">Kolom 2</div>
            </div>
        </div>
    )
}
...
function ResponsiveLayout(){
    return (
        <div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-4 md:grid-cols-3 lg:grid-cols-8 gap-4 mt-4">
