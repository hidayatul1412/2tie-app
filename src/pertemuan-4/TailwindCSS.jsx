export default function TailwindCSS(){
    return (
        <div>
            ...
            <button className="bg-blue-500 text-white px-2 mx-4 rounded shadow-lg">Click me</button>
            <Spacing/>
            <Typography/>
            <BorderRadius/>
            <BackgroundColors/>
...
function ShadowEffects(){
    return (
        <div className="bg-white shadow-lg p-6 rounded-lg hover:shadow-red-700 transition">
